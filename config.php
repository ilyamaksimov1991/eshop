...
define ('PATH', 'http://xxxxxxxxx.ru/');  //адрес домена
...
# BD
define ('SERVER_BD', 'XXXXXXX'); // имя сервера
define ('USER_BD', 'XXXXXXX');  // пользователь
define ('PASVORD', 'XXXXXXXX'); // пароль от бд
define ('NAME_BD', 'XXXXXXXXX'); // имя базы данных
...
define ("ADMIN_EMAIL","XXXXXXX@gmail.com"); // Емейл админа сайта
